          ...
          <Controller
            ...
            render={({ field: { value, onChange } }) => (
              <Checkbox
                ...
                isSelected={value === 'speaker'}
                onValueChange={(value) =>
                  onChange(value ? 'speaker' : 'participant')
                }
              >
                <div className="w-full">
                  <h1 className="text-sm font-bold">Participar como ponente</h1>
                  <p className="text-tiny text-gray-500">
                    Al participar como ponente, se te creará un perfil de
                    ponente donde podrás subir tu propuesta de trabajo. En los
                    plazos límites.
                  </p>
                </div>
              </Checkbox>
