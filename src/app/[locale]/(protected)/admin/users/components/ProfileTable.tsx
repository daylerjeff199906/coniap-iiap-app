...
import { IconEye, IconMail, IconMapPin, IconBuilding, IconChevronRight, IconLoader2 } from '@tabler/icons-react'
                                    ...
                                    <TableCell className="py-4 pr-3">
                                        <div className="flex items-center gap-1 justify-end">
                                            <Button
                                                variant="ghost"
                                                size="icon"
                                                className="h-8 w-8 rounded-xl text-muted-foreground hover:bg-slate-100 hover:text-primary transition-all opacity-0 group-hover:opacity-100"
                                                asChild
                                            >
